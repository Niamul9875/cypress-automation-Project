...
import DepositAccMarkLien from '../../BankUltimus/Common/DepositAccMarkLienPage'; // ES Module import
...
describe('Bank Ultimus', () => {
    it('Step 1: Financial Proposal Register', function () {
        ...
        const depositAccMarkLien = new DepositAccMarkLien();
        ...
        cy.task('readExcel', {
            ...
            Cypress.env('excelData', dataFinancialProposal[3]); // Use first row
    ...
    it('Step 5: Loan Account Authorization & Loan Account Disbursement', function () {
        const loginPage = new LoginPage();
        const menuSearch = new MenuSearch();
        const nftAuthorize = new NFTAuthorize();
        const logoutPage = new LogoutPage();
