...
describe('Bank Ultimus', () => {
    ...
    it('Step 5: Loan Account Authorization & Loan Account Allowable Limit Maintenance', function () {
        const loginPage = new LoginPage();
        const menuSearch = new MenuSearch();
        const nftAuthorize = new NFTAuthorize();
        const logoutPage = new LogoutPage();
        ...
        cy.task('readExcel', {
            ...
            Cypress.env('excelData', dataMenuSearch[23]); // Use 2nd row
            menuSearch.menu();
        });

        lonAllowLimitSetup.LonAccAllowLimit();
        logoutPage.Logout();//logout maker user   

    });
    it('Step 6: Loan Account Limit Maintenance Authorization & Loan Account Disbursement', function () {
        const loginPage = new LoginPage();
        const menuSearch = new MenuSearch();
        const nftAuthorize = new NFTAuthorize();
        const logoutPage = new LogoutPage();
        const lonAccTrfTrans = new LonAccTrfTrans();
        ...
        cy.task('readExcel', {
            ...
            Cypress.env('excelData', dataNftAuth[10]); // Use first row
            nftAuthorize.NftAuth();
        });
        //Go to Financing Approval Page (FP: 3131)
        cy.task('readExcel', {
    ...
    it('Step 7: Transaction Authorization & Loan Account Repayment', function () {
        const loginPage = new LoginPage();
        const menuSearch = new MenuSearch();
    ...
    it('Step 8: Transaction Authorization & Balance Inquary', function () {
        const loginPage = new LoginPage();
        const menuSearch = new MenuSearch();
        const transAuth = new TransAuth();
