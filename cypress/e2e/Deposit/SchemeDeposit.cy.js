...
describe('Bank Ultimus', () => {
    ...
    it('Step 2: Scheme Deposit Authorize & Add Nominee', function () {
        const loginPage = new LoginPage();
        const menuSearch = new MenuSearch();
    ...
    it('Step 3: Nominee Authorize & Transaction', function () {
        const loginPage = new LoginPage();
        const menuSearch = new MenuSearch();
        const nftAuthorize = new NFTAuthorize();
    ...
    it('Step 4: Transaction Authorization & Balance Inquary', function () {
        const loginPage = new LoginPage();
        const menuSearch = new MenuSearch();
